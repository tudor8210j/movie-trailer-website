...
#Purpose: This module provides movie data that is then used via the media.Movie class to create the Movie Trailer Website.
...
space_jam = media.Movie("Space Jam",
                        "Micheal Jordan kicks alien butt in basketball with the Looney Toons",
...
the_hangover = media.Movie("The Hangover",
                           "Four guys on a trip to Las Vegas for the bachelor party of a lifetime ",
...
movies = [monty_python, cloud_atlas, django, space_jam, the_hangover, the_lego_movie]
